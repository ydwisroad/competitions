...
def parse_parameters(parser=None):
    ...
    ## Required
    parser.add_argument("--input_ann", default="/Users/i052090/Downloads/segmentation/data/nlpdata/CADEC/cadec/original", type=str)
    parser.add_argument("--input_text", default="/Users/i052090/Downloads/segmentation/data/nlpdata/CADEC/cadec/text", type=str)
