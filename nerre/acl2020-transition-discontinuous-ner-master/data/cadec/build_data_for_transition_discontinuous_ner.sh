mkdir -p ./data/dai031/Experiments/CADEC/adr

echo "Extract annotations ..." >> build_data_for_transition_discontinous_ner.log
python extract_annotations.py --output_filepath ./data/dai031/Experiments/CADEC/adr/ann --log_filepath build_data_for_transition_discontinous_ner.log
