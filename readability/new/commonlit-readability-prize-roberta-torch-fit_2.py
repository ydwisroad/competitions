...
# ## RoBERTa Base Fine-Tuning with Better Training Strategies
#
# ### Steps:
...
#
# 5. There are various performance optimization techniques explained in this notebook [Speeding up Transformer w/ Optimization Strategies
...
def run(fold=0):
    ...
    model, tokenizer, optimizer, scheduler, scaler, train_loader, valid_loader, result_dict, epochs = config(fold)
